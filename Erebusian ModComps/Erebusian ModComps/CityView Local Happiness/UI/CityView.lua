...
--		UpdateSpecialists(pCity);
		...
		local iLocalHappinessMax =	math.floor(pCity:GetPopulation());
		StrLocalHappiness = Locale.ConvertTextKey("TXT_KEY_CITYVIEW_HAPPY_NOW", iLocalHappiness, iLocalHappinessMax);
		Controls.LocalHappiness:SetText(StrLocalHappiness);
		-- END Local Happiness Display
