...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvEventModifier : public CvBaseInfo
{
public:
	CvEventModifier();
	...
	EventModifierTypes getModifierType();
...
private:
	EventModifierTypes m_eModifier;
...
//  class : CvEventAction
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvEventAction : public CvBaseInfo
{
public:
	CvEventAction();
	...
	EventActionTypes getActionType();
	//ints
	int getTurns();
	int getChance();
	int getTypeToAction();
...
//  class : CvEventOption
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvEventOption : public CvBaseInfo
{
public:
	CvEventOption();
	...
	int getNumActions();
	CvEventAction& getAction(int i);

private:

	std::vector<CvEventAction> m_pEventActions;
};
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  class : CvEventInfo
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
public:
	...
	CvEventModifier& getRequirement(int i);
	int getNumModifiers();
	CvEventModifier& getModifier(int i);

	int getNumOptions();
	CvEventOption& getOption(int i);
...
private:
	...
	std::vector<CvEventModifier> m_pEventModifiers;
	std::vector<CvEventModifier> m_pEventRequirements;
	std::vector<CvEventOption> m_pEventOptions;
