...
EventModifierTypes CvGlobals::getEventModifierType(std::string szEventModifierType)
{
	std::map<std::string,int>::iterator it;
	it = m_asziEventModifierTypes.find(szEventModifierType);
	if (it != m_asziEventModifierTypes.end())
		return (EventModifierTypes)it->second;
...
EventActionTypes CvGlobals::getEventActionType(std::string szEventActionType)
{
	std::map<std::string,int>::iterator it;
	it = m_asziEventActionTypes.find(szEventActionType);
	if (it != m_asziEventActionTypes.end())
		return (EventActionTypes)it->second;
	
	return NO_EVENTACTION;
}

bool CvGlobals::EventBoolEval(bool bBool, CvEventModifier& kModifier)
{
	bool bPass = false;
...
bool CvGlobals::EventIntEval(int iInt, CvEventModifier& kModifier)
{
	bool bPass = false;
		switch(kModifier.getCompareType())
	{
