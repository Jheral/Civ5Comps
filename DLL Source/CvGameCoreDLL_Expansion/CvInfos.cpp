...
CvEventInfo::CvEventInfo() : 
	...
	m_pEventRequirements(NULL),
	m_pEventModifiers(NULL),
	m_pEventOptions(NULL)
{
}
...
bool CvEventInfo::CacheResults(Database::Results& kResults, CvDatabaseUtility& kUtility)
{
	...
	//Requirements
	{
		...
		if(pResults == NULL)
		{
			pResults = kUtility.PrepareResults(strKey, "select * from Event_Requirements where EventType = ? order by ID_Scope");
		}
		if(pResults != NULL)
		{
			pResults->Bind(1, GetType(), -1, false);
	...
	//Modifiers
	{
		...
		if(pResults == NULL)
		{
			pResults = kUtility.PrepareResults(strKey, "select * from Event_Modifiers where EventType = ? order by ID_Scope");
		}
		if(pResults != NULL)
		{
			pResults->Bind(1, GetType(), -1, false);
	...
	//Actions
	{
		...
		if(pResults == NULL)
		{
			pResults = kUtility.PrepareResults(strKey, "select * from Event_Options where EventType = ? order by ID_Scope");
		}
		if(pResults != NULL)
		{
			pResults->Bind(1, GetType(), -1, false);
...
{
	return m_pEventRequirements.size();
}

CvEventModifier& CvEventInfo::getRequirement(int i)
{
	CvAssertMsg(i < m_pEventRequirements.size(), "Index out of bounds");
	CvAssertMsg(i > -1, "Index out of bounds");
	return m_pEventRequirements[i];
}

int CvEventInfo::getNumModifiers()
{
	return m_pEventModifiers.size();
}

CvEventModifier& CvEventInfo::getModifier(int i)
{
	CvAssertMsg(i < m_pEventModifiers.size(), "Index out of bounds");
	CvAssertMsg(i > -1, "Index out of bounds");
	return m_pEventModifiers[i];
}

int CvEventInfo::getNumOptions()
{
	return m_pEventOptions.size();
}

CvEventOption& CvEventInfo::getOption(int i)
{
	CvAssertMsg(i < m_pEventOptions.size(), "Index out of bounds");
	CvAssertMsg(i > -1, "Index out of bounds");
	return m_pEventOptions[i];
}
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  class : CvEventModifier (also used for requirements)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
CvEventModifier::CvEventModifier() :
...
bool CvEventModifier::CacheResults(Database::Results& kResults, CvDatabaseUtility& kUtility)
{
	...
	//m_szScope = kResults.GetText("iScope");
	//gDLL->netMessageDebugLog("Loading modifier XML Scope " + m_szScope + "\n");

	return true;
}

EventModifierTypes CvEventModifier::getModifierType()
{
	return m_eModifier;
}

CompareTypes CvEventModifier::getCompareType()
{
	return m_eCompare;
}

std::string CvEventModifier::getScope()
{
	return m_szScope;
}

int CvEventModifier::getTypeToCompare()
{
	return m_iTypeToCompare;
}

int CvEventModifier::getNumberToCompare()
{
	return m_iNumberToCompare;
}

int CvEventModifier::getFactor()
{
	return m_iFactor;
}
...
//  class : CvEventOption
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
CvEventOption::CvEventOption() :
	m_pEventActions(NULL)
{
}

bool CvEventOption::CacheResults(Database::Results& kResults, CvDatabaseUtility& kUtility)
{
	...
	//Actions
	{
		...
		if(pResults == NULL)
		{
			pResults = kUtility.PrepareResults(strKey, "select * from Event_Actions where EventOptionType = ? order by ID_Scope");
		}
		if(pResults != NULL)
		{
			pResults->Bind(1, GetType(), -1, false);
			...
			while(pResults->Step())
			{
				...
				CvEventAction pNewEvent;
				pNewEvent.CacheResults(*pResults, kUtility);
				gDLL->netMessageDebugLog("Loading option actions 3.4 \n");
				m_pEventActions.push_back(pNewEvent);
				gDLL->netMessageDebugLog("Loading option actions 3.8 \n");
...
int CvEventOption::getNumActions()
{
	return m_pEventActions.size();
}

CvEventAction& CvEventOption::getAction(int i)
{
	CvAssertMsg(i < m_pEventActions.size(), "Index out of bounds");
	CvAssertMsg(i > -1, "Index out of bounds");
	return m_pEventActions[i];
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  class : CvEventAction
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
CvEventAction::CvEventAction() :
...
bool CvEventAction::CacheResults(Database::Results& kResults, CvDatabaseUtility& kUtility)
{
...
EventActionTypes CvEventAction::getActionType()
{
	return m_eAction;
}

int CvEventAction::getTurns()
{
	return m_iTurns;
}

int CvEventAction::getChance()
{
	return m_iChance;
}

int CvEventAction::getTypeToAction()
{
	return m_iTypeToAction;
}

int CvEventAction::getAIWeight()
{
	return m_AIWeight;
}

int CvEventAction::getValue1()
{
	return m_iValue1;
}

int CvEventAction::getValue2()
{
	return m_iValue2;
}

bool CvEventAction::getBool1()
{
	return m_bBool1;
}

std::string CvEventAction::getString1()
{
	return m_szString1;
}
// END EventEngine