...
void CvLuaPlayer::PushMethods(lua_State* L, int t)
{
	...
	Method(ProcessEventOptionByID);
	Method(GetNumEvents);
	Method(GetEvent);
	Method(AddEvent);
	Method(DeleteEvent);

	Method(GetNumTempEventEffects);
	Method(GetTempEventEffect);

	Method(GetHappyFromEvents);
	Method(GetYieldFromEvents);
	Method(GetYieldModifierFromEvents);
...
int CvLuaPlayer::lProcessEventOptionByID(lua_State* L)
{
	return BasicLuaMethod(L, &CvPlayerAI::processEventOptionByID);
}
...
int CvLuaPlayer::lGetEvent(lua_State* L)
{
	CvPlayerAI* pkPlayer = GetInstance(L);
	const int id = lua_tointeger(L, 2);
...
int CvLuaPlayer::lGetNumTempEventEffects(lua_State* L)
{
	return BasicLuaMethod(L, &CvPlayerAI::getNumTempEventEffects);
}
int CvLuaPlayer::lGetTempEventEffect(lua_State* L)
{
	CvPlayerAI* pkPlayer = GetInstance(L);
	const int id = lua_tointeger(L, 2);
...
int CvLuaPlayer::lGetYieldFromEvents(lua_State* L)
{
	return BasicLuaMethod(L, &CvPlayerAI::getYieldFromEvents);
}

int CvLuaPlayer::lGetYieldModifierFromEvents(lua_State* L)
{
	return BasicLuaMethod(L, &CvPlayerAI::getYieldModifierFromEvents);
}
