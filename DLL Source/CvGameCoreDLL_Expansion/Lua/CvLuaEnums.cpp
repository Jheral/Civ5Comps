...
int CvLuaEnums::pRegister(lua_State* L)
{
	...
	// EventModifierTypes
	EnumStart(L, "EventModifierTypes");
	RegisterEnum(NO_EVENTMOD);
	RegisterDynamicEnums(L, "EventModifierTypes", "ID", "Name", "NUM_EVENTMOD_TYPES");
	EnumEnd(L);

	// EventActionTypes
	EnumStart(L, "EventActionTypes");
	RegisterEnum(NO_EVENTACTION);
	RegisterDynamicEnums(L, "EventActionTypes", "ID", "Name", "NUM_EVENTACTION_TYPES");
	EnumEnd(L);
	// END EventEngine
