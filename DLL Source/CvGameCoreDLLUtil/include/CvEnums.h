...
enum PolicyBranchClassTypes
{
	NO_POLICY_BRANCH_CLASS_TYPE = -1,
};
...
enum EventModifierTypes
{
	NO_EVENT_MODIFIER = -1,
};

enum EventRequirementTypes
{
	NO_EVENT_REQUIREMENT = -1,
};
...
// any additions need to be reflected in xml
// any additions must also be between the appropriate EVENTMOD_X_START and EVENTMOD_X_END
enum EventModifierTypeTypes
{
	NO_EVENTMOD = -1,
	...
	EVENTMOD_GOLD,
	EVENTMOD_GOLDPERTURN,
	EVENTMOD_CULTUREPERTURN,
	EVENTMOD_CULTURE,
	EVENTMOD_CULTURETOTAL,
	EVENTMOD_FAITHPERTURN,
	EVENTMOD_FAITH,
	EVENTMOD_FAITHTOTAL,
	EVENTMOD_SCIENCEPERTURN,

	EVENTMOD_HAPPINESS,
	EVENTMOD_EXCESSHAPPINESS,
	EVENTMOD_UNHAPPY,
	EVENTMOD_VERYUNHAPPY,
	EVENTMOD_SUPERUNHAPPY,

	EVENTMOD_RESOURCE,
	EVENTMOD_RESOURCE_AVAILABLE,
	EVENTMOD_RESOURCE_CLASS,
	EVENTMOD_RESOURCE_CLASS_AVAILABLE,
	...
	EVENTMOD_NUMCITIES,
	EVENTMOD_LOSTCAPITAL,
	EVENTMOD_CITIESLOST,
	EVENTMOD_PUPPETCITIES,
	EVENTMOD_BUILDINGCLASS,
	EVENTMOD_NUMWONDERS,

	EVENTMOD_HUMAN,
	EVENTMOD_BARBARIAN,
	EVENTMOD_HANDICAP,
	EVENTMOD_CIVILIZATION,
	EVENTMOD_LEADER,
	EVENTMOD_PERSONALITY,

	EVENTMOD_MINORCIV,
	EVENTMOD_MAJORCIV,

	//EVENTMOD_STATERELIGION,

	EVENTMOD_POPULATION,
	EVENTMOD_AVERAGEPOPULATION,
	EVENTMOD_LAND,

	EVENTMOD_POLICY,
	EVENTMOD_POLICIESTOTAL,
	EVENTMOD_POLICYBRANCH,

	EVENTMOD_ANARCHY,
	EVENTMOD_GOLDENAGE,

	EVENTMOD_POWER,
	EVENTMOD_MILITARYMIGHT,
	EVENTMOD_ECONOMICMIGHT,
	EVENTMOD_ERA,
...
// any additions need to be reflected in xml
// any additions must also be between the appropriate EVENTACTION_X_START and EVENTACTION_X_END
enum EventActionTypeTypes
{
	NO_EVENTACTION = -1,
	...
	EVENTACTION_CHANGE_ROUTE,
	EVENTACTION_CHANGE_FEATURE,
	EVENTACTION_CHANGE_RESOURCE,
	EVENTACTION_CHANGE_IMPROVEMENT,

	NUM_EVENTACTION_TYPES
};
// END EventEngine
